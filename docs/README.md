...
User-facing and developer-facing documentation for RABET 1.4.1.

| Document | Audience | Description |
| --- | --- | --- |
| [User Guide (English)](USER_GUIDE.md) | End users | End-to-end walkthrough of RABET 1.4.1: annotation, state/point event types, multi-file analysis, bout analysis, transition analysis, visualisation, reliability assessment, project mode, and troubleshooting. |
| [User Guide (Japanese)](USER_GUIDE.ja.md) | End users | Natural Japanese-language guide covering the same RABET 1.4.1 workflows. |
