...
| [User Guide (日本語)](USER_GUIDE.ja.md) | エンドユーザー | RABET の全機能を網羅した日本語版ユーザーガイド。 |
| [CSV format specification](CSV_FORMAT.md) | End users, integrators | Complete specification of the annotation, summary, and interval-summary CSV layouts (schema v0 and v1) with a minimal pandas parser. |
