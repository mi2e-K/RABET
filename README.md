...
[![Version](https://img.shields.io/badge/version-1.4.2-blue)](https://github.com/mi2e-K/RABET/releases)
...
For the installer build, unzip `RABET-Windows-1.4.2-Setup.zip` and run
`RABET-Setup.exe`. For the portable build, unzip
`RABET-Windows-1.4.2-portable.zip` and launch `RABET.exe` directly.
