# controllers/analysis_controller.py - Enhanced with file management and export options
import logging
import os
import time
...
class AnalysisController(QObject):
    ...
    def on_files_dropped(self, file_paths):
        ...
        """
        self.logger.debug(f"Files dropped: {file_paths}")
    ...
    def _auto_export_results(self, results):
        ...
        try:
            ...
            if self._view._file_paths:
                ...
                # Default filename is summary_table.csv
            ...
            if self._model.export_summary_csv(export_path):
                ...
                AutoCloseMessageBox.information(
                    self._view,
                    "Export Complete",
                    f"Analysis results automatically exported to:\n{export_path}",
                    timeout=2000
                )
